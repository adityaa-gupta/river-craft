...
export default function NavbarLayout({
  ...
  return (
   <div 
      className="flex flex-col min-h-screen w-screen h-screen bg-fixed bg-cover bg-center relative"
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex-shrink-0 group">
              <div className="flex items-center space-x-2">
                ...
                />
                <span className="font-semibold text-lg text-gray-900">River Craft</span>
              </div>
            </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col space-y-3">
            <Link href="/" className="flex items-center space-x-2">
              <img src="/file.svg" alt="River Craft" className="h-9 w-auto" />
              <span className="font-semibold text-lg text-gray-900">River Craft</span>
            </Link>
            <p className="text-sm text-gray-600 leading-relaxed max-w-sm">
              Building creative digital experiences with modern design and performance.
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-3">
            ...
            <div className="flex space-x-4">
              <a href="#" aria-label="Twitter" className="p-2 rounded-full bg-gray-100 hover:bg-[#109c9e] transition">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-600 hover:text-[#109c9e]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" aria-label="GitHub" className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-600 hover:text-black" fill="currentColor" viewBox="0 0 24 24">
